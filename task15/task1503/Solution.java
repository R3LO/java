...
public class Solution {
    ...
    public static class Ferrari extends LuxuriousCar{
        public void printlnDesire() {
            //add your code here
            String s = Constants.WANT_STRING + Constants.FERRARI_NAME;
    ...
    public static class Lanos extends CheapCar{
        public void printlnDesire() {
            //add your code here
            String s = Constants.WANT_STRING + Constants.LANOS_NAME;
            System.out.println(s);
    ...
    public static class LuxuriousCar {
        private void printlnDesire() {
            String s = Constants.WANT_STRING + Constants.LUXURIOUS_CAR;
            System.out.println(s);
        }
    }
    public static class CheapCar {
        private void printlnDesire() {
            String s = Constants.WANT_STRING + Constants.CHEAP_CAR;
            System.out.println(s);
        }
    }
